...
class SearchBar extends StatefulWidget {
  ...
  final SearchBarType searchBarType; // 搜索栏 3种样式展现
  final String hint; // 首页提示文案
  final String defaultText; // 默认文案
  final void Function() leftButtonClick;
  final void Function() rightButtonClick;
  final void Function() speakClick; // 语音按钮
...
class _SearchBarState extends State<SearchBar> {
  ...
  final TextEditingController _controller = TextEditingController(); // 监听输入框变化
